<template>
  <div class="block">
    <p>
      One of the most popular RR models ever.
      Up until the release of the RR24 in late 2006, the only 24-frets standard production Rhoads available outside of Japan was the entry-level JS30RR.
      The only alternative was a USA Custom Shop order.
    </p>
    <br/>
    <p>
