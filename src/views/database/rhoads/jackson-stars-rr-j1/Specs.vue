<template>
  <div class="block">
    ...
    <p><i>RR-J1/J1K/J1B:</i> Seymour Duncan SH-1n (neck), TB-5/SH-5 (bridge)</p>
    <p><i>RR-J1E/J1EK/J1BE:</i> EMG-81 (neck and bridge)</p>
    <p><strong>Controls:</strong> 2x Volume, 1x Tone, 3-Way Toggle Switch</p>
    <p><strong>Bridge:</strong></p>
    <p><i>RR-J1/J1E:</i> Floyd Rose Original</p>
    <p><i>RR-J1K/J1EK:</i> Kahler</p>
    <p><i>RR-J1B/J1BE:</i> Tune-o-matic Gotoh bridge with string-through-body</p>
    ...
    <p><i>RR-J1:</i> &#165;220,000</p>
    <p><i>RR-J1E:</i> &#165;225,000</p>
    <p><i>RR-J1K:</i> &#165;240,000</p>
    <p><i>RR-J1EK:</i> &#165;245,000</p>
    <p><i>RR-J1B:</i> &#165;170,000</p>
    <p><i>RR-J1BE:</i> &#165;175,000</p>
  </div>
</template>
