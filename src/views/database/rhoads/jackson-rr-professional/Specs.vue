<template>
  <div class="block">
    ...
    <p><strong>Finishes:</strong> <i>As per 1990/91 catalogue:</i> Midnight Black, Ferrari Red, Pearl Yellow, Pearl Yellow with Black Bevels, Snow White Pearl with Black Bevels, Radiant Red with Black Bevels</p>
    <p><strong style="color: white;">Finishes:</strong> <i>As per 1992 catalogue:</i> BLK (Black), DMB (Dark Metallic Blue), SW (Snow White)</p>
    <p><strong style="color: white;">Finishes:</strong> <i>As per 1993 catalogue:</i> BLK (Black), DMB (Dark Metallic Blue), SW (Snow White), DMR (Dark Metallic Red)</p>
    <p><strong style="color: white;">Finishes:</strong> <i>As per 1994/5 catalogue:</i> BLK (Black), DMB (Dark Metallic Blue), BC (?)</p>
