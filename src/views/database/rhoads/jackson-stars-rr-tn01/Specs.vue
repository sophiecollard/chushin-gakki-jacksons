<template>
  <div class="block">
    ...
    <p><strong>Pickups:</strong> <i>RR-TN01/TN01STB:</i> Seymour Duncan SH-1n (neck), TB-4/SH-4 (bridge)</p>
    ...
    <p><strong>Bridge:</strong> <i>RR-TN01/TN01EMG:</i> Floyd Rose Original</p>
    ...
    <p><strong>Hardware:</strong> <i>RR-TN01/TN01EMG:</i> Black</p>
