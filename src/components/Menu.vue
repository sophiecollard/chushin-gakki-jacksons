    ...
    <ul class="menu-list" v-show=databaseMenuShown>
      ...
      <li>
        ...
        <ul v-show=rhoadsSectionExpanded>
          ...
          <li><router-link to="/db/rr/jackson-rr-elite-fsr">Jackson Rhoads Elite FSR</router-link></li>
          ...
          <li><router-link to="/db/rr/jackson-rr5fr">Jackson RR5FR</router-link></li>
          ...
          <li><router-link to="/db/rr/jackson-stars-rr-tn02-ltd">Jackson Stars RR-TN02 LTD</router-link></li>
          <li><router-link to="/db/rr/jackson-stars-rr-tn02stb-ash">Jackson Stars RR-TN02STB ASH</router-link></li>
          <li><router-link to="/db/rr/jackson-stars-rr-tn02stb-ltd">Jackson Stars RR-TN02STB LTD</router-link></li>
